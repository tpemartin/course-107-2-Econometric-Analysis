...
```{r,results='asis'}
lm(log(subs)~log(citeprice),data=journals) -> model1

lm(log(subs)~log(citeprice)+foundingyear,data=journals) -> model2
...
lm(log(subs)~log(citeprice),data=journals) -> model_1

lm(log(subs)~log(citeprice)+foundingyear,data=journals) -> model_2
